...
public class MenuScene extends Scene {
    ...
    public MenuScene(Window window) {
        ...
        buttons.add(new MenuButton(window, this, "Tutorial", TUTORIAL, getWindow().getWidth() / 2 - (MENU_BUTTON_WIDTH / 2), 250 + MENU_BUTTON_HEIGHT * 1.1f));
        ...
        buttons.add(new MenuButton(window, this, "Credits", CREDITS, getWindow().getWidth() / 2 - (MENU_BUTTON_WIDTH / 2), 250 + MENU_BUTTON_HEIGHT * 3.3f));
        ...
        decorations.add(new Decoration(window, "title_banner", getWindow().getWidth() / 2 - (TITLE_BANNER_WIDTH / 2), 100, TITLE_BANNER_WIDTH, TITLE_BANNER_HEIGHT));
    }
